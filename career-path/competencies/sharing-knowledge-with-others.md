...
[Working together with other developers](/career-path/competencies/taking-the-lead-in-a-pair-situation.md) is a really good way to share knowledge, since you get to see other dev's workflow, environment and editor/ide config, and general approaches to problem solving.
...
[The GDS styleguide](https://github.com/alphagov/styleguides/blob/master/pull-requests.md#guidance-for-each-step) has guidance about how to do good code reviews well.
